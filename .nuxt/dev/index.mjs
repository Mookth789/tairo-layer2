...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///project/sandbox/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///project/sandbox/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///project/sandbox/node_modules/devalue/index.js';
...
import { klona } from 'file:///project/sandbox/node_modules/klona/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///project/sandbox/node_modules/ufo/dist/index.mjs';
...
const _lazy_YB8vCg = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YB8vCg, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YB8vCg, lazy: true, middleware: false, method: undefined }
];
